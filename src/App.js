  ...
  return (
    <div className="App">
      ...
      <div className="Text-container">
        ...
        <p>If this sounds up your alley then get on our guest list here!</p>
        <a
          id="text-link"
      ...
      <p className="Section-header">With Special Performances By:</p>
      {/* Ariel */}
      <a
        href="https://www.instagram.com/ariel.ist/"
        rel="noreferrer"
        target="_blank"
        className="Talent-card"
      >
        <img className="Talent-img" id="ariel-img" src={ariel} alt=""></img>
      ...
      {/* Kandii Viibe Check */}
      <p className="Section-header">Our Kandii Viibes</p>
      ...
      <div className="Genre-container">
        <p>Big-Room Bonanza</p>
      </div>

      <div className="Genre-container">
        <p>In Your Face Electro</p>
      </div>

      <div className="Genre-container">
        <p>Complextro Killers</p>
      </div>
      ...
      <div className="Genre-container">
        <p>Euro-Trance Euphoria</p>
      </div>

      <div className="Genre-container">
        <p>Mid-Tempo Madness</p>
      </div>

      <div className="Genre-container">
        <p>
          Kandii Klassics <br></br>
          sing-a-long
        </p>
      </div>
